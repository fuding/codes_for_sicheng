...
class AWSRN_SD_ED_AW_MN(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=16, ks=3, block_feats=128):
        super(AWSRN_SD_ED_AW_MN, self).__init__()
        ...
        self.LFB_D = LFB_D(n_feats, ks, block_feats, wn, act, exp=8)
...
class LFB_D(nn.Module):
    def __init__(
        self, n_feats, kernel_size, block_feats, wn, act=nn.ReLU(True), exp=6):
        super(LFB_D, self).__init__()
        self.b0 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b1 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b2 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b3 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b4 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b5 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b6 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b7 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)
        self.b8 = InvertedResidual_AW(n_feats, n_feats, expansion_factor=exp)

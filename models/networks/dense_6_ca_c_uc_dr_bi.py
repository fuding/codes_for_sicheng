...
class Dense_6_CA_C_UC_DR_BI(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        super(Dense_6_CA_C_UC_DR_BI, self).__init__()
        ...
        self.d1 = nn.Sequential(
            ...
            UpCBlock(n_feats * 2, fc * 2, norm=True, act_type='relu', mode='bilinear')
        )

        self.d2 = nn.Sequential(
            nn.Conv2d(fc * 4, fc, 1, 1, 0),
            UpCBlock(fc, fc, norm=True, act_type='relu', mode='bilinear')
        )

...
class AWSRN_SD_ED_AW_IA(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=16, ks=3, block_feats=128):
        ...
        self.ia_12_1 = InputAttention(fc*2, fc)
        self.ia_12_2 = InputAttention(fc*2*2, fc*2)
        ...
        self.ia_23_1 = InputAttention(fc * 2, fc)
        self.ia_23_2 = InputAttention(fc * 2 * 2, fc * 2)
    ...
    def forward(self, in_LDRs, in_HDRs):
        ...
        e1_1 = self.ia_12_1(torch.cat((e1_1, e2_1), 1))
        e3_1 = self.ia_23_1(torch.cat((e2_1, e3_1), 1))

        e1_2 = self.e1_2(e1_1)
        e2_2 = self.e2_2(e2_1)
        e3_2 = self.e3_2(e3_1)

        e1_2 = self.ia_12_2(torch.cat((e1_2, e2_2), 1))
        e3_2 = self.ia_23_2(torch.cat((e2_2, e3_2), 1))

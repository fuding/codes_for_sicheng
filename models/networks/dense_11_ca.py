...
class Dense_11_CA(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        ...
        self.dense_block_3 = DenseBlock(n_feats, reduction, attention_blcok=ChannelAttention)
    ...
    def forward(self, in_LDRs, in_HDRs):
        ...
        dense_blcok_2 = self.dense_block_2(dense_blcok_1)
        dense_blcok_3 = self.dense_block_3(dense_blcok_2)

        d1 = self.awms_scale(dense_blcok_3) + self.e_3_scale(e_3)
        d1 = self.d1(d1)

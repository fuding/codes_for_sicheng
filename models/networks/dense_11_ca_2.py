...
class Dense_11_CA_2(nn.Module):
    ...
    def forward(self, in_LDRs, in_HDRs):
        ...
        c2 = self.c2(c2)
        dense_blcok_3 = self.dense_block_3(c2)
        c3 = torch.cat((e_3, dense_blcok_1, dense_blcok_2, dense_blcok_3), 1)
        c3 = self.c3(c3)

        d1 = self.awms_scale(c3) + self.e_3_scale(e_3)
        d1 = self.d1(d1)

...
class Dense_6_RAM_Mobile(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        ...
        self.block2 = Block2(n_feats, reduction=reduction, attention_block=RAM)
        self.block3 = Block3(n_feats, reduction=reduction, attention_block=RAM)
        self.block4 = Block4(n_feats, reduction=reduction, attention_block=RAM)

...
class Block2(nn.Module):
    ...
    def forward(self, x):
        ...
        cat4 = torch.cat((b3, x[3], c1, b1, b2), 1)
        c4 = self.c4(cat4)
        b4 = self.b4(c4)

        cat5 = torch.cat((b1, b2, b3, b4, c1), 1)
        c5 = self.c5(cat5)
...
class Block3(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        cat3 = torch.cat((c1, b1, b2, x2[2], x1[1]), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat4 = torch.cat((x2[3], x1[3], c1, b1, b2, b3), 1)
        c4 = self.c4(cat4)
        b4 = self.b4(c4)
...
class Block4(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        cat2 = torch.cat((x3[1], x2[1], x1[1], c1, b1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)
        ...
        cat4 = torch.cat((x3[3], x2[3], x1[3], c1, b1, b2, b3), 1)
        c4 = self.c4(cat4)
        b4 = self.b4(c4)

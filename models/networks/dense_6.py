...
class Dense_6(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        ...
        self.block2 = Block2(n_feats, reduction=reduction)
        self.block3 = Block3(n_feats, reduction=reduction)
        self.block4 = Block4(n_feats, reduction=reduction)
...
class Block2(nn.Module):
    ...
    def forward(self, x):
        ...
        cat5 = torch.cat((c1, b1, b2, b3, b4), 1)
        c5 = self.c5(cat5)
...
class Block3(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        cat2 = torch.cat((c1, b1, x2[1], x1[1]), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((c1, b1, b2, x2[2], x1[2]), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat4 = torch.cat((c1, b1, b2, b3, x2[3], x1[3]), 1)
        c4 = self.c4(cat4)
        b4 = self.b4(c4)
...
class Block4(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        cat2 = torch.cat((c1, b1, x3[1], x2[1], x1[1]), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((c1, b1, b2, x3[2], x2[2], x1[2]), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat4 = torch.cat((c1, b1, b2, b3, x3[3], x2[3], x1[3]), 1)
        c4 = self.c4(cat4)
        b4 = self.b4(c4)

        c5 = torch.cat((c1, b1, b2, b3, b4), 1)
        c5 = self.c5(c5)

...
class Block3(nn.Module):
    ...
    def forward(self, x_in, x2):
        ...
        cat1 = torch.cat((x_in, x2[0], x2[-1]), 1)
        c1 = self.c1(cat1)
        b1 = self.b1(c1)

        cat2 = torch.cat((x2[1], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x2[2], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x2[3], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)
...
class Block4(nn.Module):
    ...
    def forward(self, x_in, x3):
        ...
        cat1 = torch.cat((x_in, x3[-1], x3[0]), 1)
        c1 = self.c1(cat1)
        b1 = self.b1(c1)

        cat2 = torch.cat((x3[1], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x3[2], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x3[3], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

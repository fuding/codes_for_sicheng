...
class Block3(nn.Module):
    ...
    def forward(self, x_in, x2):
        ...
        cat2 = torch.cat((x2[0], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x2[1], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x2[2], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

        c5 = torch.cat((b1, b2, b3, b4, c1, x2[3]), 1)
        c5 = self.c5(c5)
...
class Block4(nn.Module):
    ...
    def forward(self, x_in, x3):
        ...
        cat2 = torch.cat((x3[0], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x3[1], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x3[2], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

        c5 = torch.cat((b1, b2, b3, b4, c1, x3[3]), 1)
        c5 = self.c5(c5)

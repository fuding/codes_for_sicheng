...
class Block2(nn.Module):
    ...
    def forward(self, x_in, x):
        ...
        cat2 = torch.cat((b1, x[0], c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((b2, x[1], c1, b1), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((b3, x[2], c1, b1, b2), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

        c5 = torch.cat((b1, b2, b3, b4, c1, x[3]), 1)
        c5 = self.c5(c5)
...
class Block3(nn.Module):
    ...
    def forward(self, x_in, x1, x2):
        ...
        cat2 = torch.cat((x2[0], x1[0], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x2[1], x1[1], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x2[2], x1[2], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

        c5 = torch.cat((b1, b2, b3, b4, c1, x2[3], x1[3]), 1)
        c5 = self.c5(c5)
...
class Block4(nn.Module):
    ...
    def forward(self, x_in, x1, x2, x3):
        x_list = []
        ...
        cat2 = torch.cat((x3[0], x2[0], x1[0], b1, c1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x3[1], x2[1], x1[1], c1, b1, b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x3[2], x2[2], x1[2], c1, b1, b2, b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

        c5 = torch.cat((b1, b2, b3, b4, c1, x3[3], x2[3], x1[3]), 1)
        c5 = self.c5(c5)
...
class DenseBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        x_list3 = self.block3(x3, x_list1, x_list2)
        x_list4 = self.block4(x4, x_list1, x_list2, x_list3)

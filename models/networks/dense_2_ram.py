...
class Dense_2_RAM(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        ...
        self.block1 = FirstBlock(n_feats, reduction=reduction, attention_block=RAM)
        self.block2 = NormalBlock(n_feats, reduction=reduction, attention_block=RAM)
        self.block3 = NormalBlock(n_feats, reduction=reduction, attention_block=RAM)
        self.block4 = NormalBlock(n_feats, reduction=reduction, attention_block=RAM)

...
class Dense_6_CA_C_UC(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, num_blocks=4, reduction=4):
        ...
        self.d1 = nn.Sequential(
            ...
            UpCBlock(n_feats * 2, fc * 2, norm=True, act_type='relu')
        )

        self.d2 = UpCBlock(fc * 4, fc, norm=True, act_type='relu')

        self.d3 = UpCBlock(fc * 2, fc, norm=True, act_type='relu')

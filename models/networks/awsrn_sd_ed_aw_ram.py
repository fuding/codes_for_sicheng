...
class AWSRN_SD_ED_AW_RAM(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=16, ks=3, block_feats=128):
        super(AWSRN_SD_ED_AW_RAM, self).__init__()
        ...
        self.LFB_D = LFB_D(n_feats, ks, block_feats, wn, act, attention_block=RAM)
...
class LFB_D(nn.Module):
    def __init__(
        self, n_feats, kernel_size, block_feats, wn, act=nn.ReLU(True), attention_block=None, reduction=4):
        super(LFB_D, self).__init__()
        self.b0 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b1 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b2 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b3 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b4 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b5 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b6 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
        self.b7 = AWRU(n_feats, kernel_size, block_feats, wn=wn, act=act, attention_block=attention_block, reduction=reduction)
...
class AWRU(nn.Module):
    def __init__(
        self, n_feats, kernel_size, block_feats, wn, res_scale=1, act=nn.ReLU(True), attention_block=None, reduction=4):
        ...
        self.attention = attention_block(n_feats, reduction)

        self.body = nn.Sequential(*body)

    def forward(self, x):
        res = self.res_scale(self.attention(self.body(x))) + self.x_scale(x)
        return res

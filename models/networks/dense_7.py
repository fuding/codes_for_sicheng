...
class Block2(nn.Module):
    ...
    def forward(self, x):
        ...
        cat2 = torch.cat((b1, x[1]), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((b2, x[2]), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((b3, x[3]), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)
...
class Block3(nn.Module):
    def __init__(self, n_feats, exp=6, reduction=4, attention_block=None):
        ...
        self.c4 = BasicBlock(n_feats * 3, n_feats, 1, 1, 0)
        self.c5 = BasicBlock(n_feats * 4, n_feats, 1, 1, 0)
    ...
    def forward(self, x1, x2):
        ...
        cat2 = torch.cat((x2[1], x1[1], b1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x2[2], x1[1], b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x2[3], x1[3], b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)
...
class Block4(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        cat2 = torch.cat((x3[1], x2[1], x1[1], b1), 1)
        c2 = self.c2(cat2)
        b2 = self.b2(c2)

        cat3 = torch.cat((x3[2], x2[2], x1[1], b2), 1)
        c3 = self.c3(cat3)
        b3 = self.b3(c3)

        cat5 = torch.cat((x3[3], x2[3], x1[3], b3), 1)
        c4 = self.c4(cat5)
        b4 = self.b4(c4)

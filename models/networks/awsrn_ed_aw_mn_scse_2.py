...
class AWSRN_ED_AW_MN_scSE_2(nn.Module):
    def __init__(self, in_c=6, out_c=3, fc=64, n_feats=32, ks=3, block_feats=128, num_blocks=3, reduction=4):
        ...
        for i in range(num_blocks):
            lfb.append(LFB(n_feats, wn, exp=6, reduction=reduction, attention_block=scSE_2))
